...
async fn handle_ws(mut socket: WebSocket, state: Arc<AppState>) {
    ...
    let cfg_json = r#"{"evse_id":"default","interface":"lo","energy_services":["AC_DER"],"auth_services":["EIM"],"control_mode":"Dynamic","mobility_mode":"ProvidedByEvcc","ac_limits":{"max_charge_power":22080,"min_charge_power":20000}}"#;
